...
namespace ShaderGen.Tests.AutoGenerated
{
    ...
    internal class TestSet
    {
            ...
            ITestOutputHelper output)
        {
            ...
            {
                setSource = generationResult.GetOutput(Backend).Single();
                compilationResult =
                    ToolChain.Compile(setSource.ComputeShaderCode, Stage.Compute, setSource.ComputeFunction.Name);
            }

            if (compilationResult.HasError)
            {
                output.WriteLine($"Failed to compile Compute Shader from set \"{setSource.Name}\"!");
